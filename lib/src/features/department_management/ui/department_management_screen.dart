                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          context.read<DepartmentManagementBloc>().add(
                            DepartmentManagementEvent.removeDepartment(department),
                          );
                        },
                      ),
                      onTap: () async {
  ...
  Future<void> _showAddDialog(BuildContext context) async {
    ...
    await showDialog<String>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title: Text(I18n.of(context).department_management_alert_dialog_add_title),
          content: Column(
            ...
            children: [
              TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: I18n.of(context).department_management_alert_dialog_name)),
            ],
          ),
          actions: [
            TextButton(
  ...
  Future<Department?> _showEditDialog(
    ...
    return showDialog<Department>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title:
          Text(I18n.of(context).department_management_alert_dialog_edit_title),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(
