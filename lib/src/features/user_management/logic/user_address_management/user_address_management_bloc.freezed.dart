...
abstract class $UserAddressManagementStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Address> addresses, int userId});
}
...
class _$UserAddressManagementStateImpl implements _UserAddressManagementState {
  const _$UserAddressManagementStateImpl(
      {required final List<Address> addresses, required this.userId})
  ...
  @override
  String toString() {
    return 'UserAddressManagementState(addresses: $addresses, userId: $userId)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_addresses), userId);
