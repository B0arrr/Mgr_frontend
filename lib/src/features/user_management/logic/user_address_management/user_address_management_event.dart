...
class UserAddressManagementEvent with _$UserAddressManagementEvent {
  ...
  const factory UserAddressManagementEvent.addUserAddress(UserAddress userAddress) =
      _AddUserAddress;

  const factory UserAddressManagementEvent.removeUserAddress(UserAddress userAddress) =
      _RemoveUserAddress;
