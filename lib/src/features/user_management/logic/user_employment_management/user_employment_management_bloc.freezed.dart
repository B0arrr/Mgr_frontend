...
mixin _$UserEmploymentManagementState {
  List<UserEmployment> get employments => throw _privateConstructorUsedError;
...
abstract class $UserEmploymentManagementStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<UserEmployment> employments, int userId});
}
...
class _$UserEmploymentManagementStateImpl
  ...
  const _$UserEmploymentManagementStateImpl(
      {required final List<UserEmployment> employments, required this.userId})
      : _employments = employments;

  final List<UserEmployment> _employments;
  @override
  List<UserEmployment> get employments {
  ...
  @override
  String toString() {
    return 'UserEmploymentManagementState(employments: $employments, userId: $userId)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_employments), userId);
...
abstract class _UserEmploymentManagementState
  ...
  const factory _UserEmploymentManagementState(
      {required final List<UserEmployment> employments,
