                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          context.read<PositionManagementBloc>().add(
                            PositionManagementEvent.removePosition(position),
                          );
                        },
                      ),
                      onTap: () async {
  ...
  Future<void> _showAddDialog(BuildContext context) async {
    ...
    await showDialog<String>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title: Text(I18n.of(context).position_management_alert_dialog_add_title),
          content: Column(
            ...
            children: [
              TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: I18n.of(context).position_management_alert_dialog_name)),
            ],
          ),
          actions: [
            TextButton(
  ...
  Future<Position?> _showEditDialog(
    ...
    return showDialog<Position>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title:
          Text(I18n.of(context).position_management_alert_dialog_edit_title),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(
