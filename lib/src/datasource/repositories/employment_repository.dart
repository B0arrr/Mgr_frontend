...
import '../models/Employment/employment.dart';
...
class EmploymentRepository extends BaseRepository {
  ...
  Future<ApiResponse<Employment, ApiError>> addEmployment(Employment employment) async {
    return runApiCall(call: () async {
  ...
  Future<ApiResponse<Employment, ApiError>> updateEmployment(int id, Employment employment) async {
    return runApiCall(call: () async {
