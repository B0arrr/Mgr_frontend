...
class UserManagerRepository extends BaseRepository {
  ...
  Future<ApiResponse<UserManager, ApiError>> addUserManager(UserManager userManager) async {
    return runApiCall(call: () async {
  ...
  Future<ApiResponse<UserManager, ApiError>> updateUserManager(int id, UserManager userManager) async {
    return runApiCall(call: () async {
