...
class UserAddressRepository extends BaseRepository {
  ...
  Future<ApiResponse<UserAddress, ApiError>> addUserAddress(UserAddress userAddress) async {
    return runApiCall(call: () async {
  ...
  Future<ApiResponse<UserAddress, ApiError>> updateUserAddress(int id, UserAddress userAddress) async {
    return runApiCall(call: () async {
