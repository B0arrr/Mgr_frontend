...
class UserEmploymentRepository extends BaseRepository {
  ...
  Future<ApiResponse<List<UserEmployment>, ApiError>> getUserEmployments() async {
  ...
  Future<ApiResponse<UserEmployment, ApiError>> getUserEmployment(int id) async {
    return runApiCall(call: () async {
  ...
  Future<ApiResponse<UserEmployment, ApiError>> addUserEmployment(UserEmployment userEmployment) async {
    return runApiCall(call: () async {
      final response = await _userEmploymentApi.addUserEmployment(userEmployment);
      return ApiResponse.success(response);
    });
  }

  Future<ApiResponse<UserEmployment, ApiError>> updateUserEmployment(int id, UserEmployment userEmployment) async {
    return runApiCall(call: () async {
      final response = await _userEmploymentApi.updateUserEmployment(id, userEmployment);
      return ApiResponse.success(response);
    });
  }

  Future<ApiResponse<UserEmployment, ApiError>> deleteUserEmployment(int id) async {
    return runApiCall(call: () async {
