...
abstract class $UserAddressCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int user_id, int address_id, bool is_remote});
}
...
class _$UserAddressImpl implements _UserAddress {
  ...
  @override
  String toString() {
    return 'UserAddress(id: $id, user_id: $user_id, address_id: $address_id, is_remote: $is_remote)';
  }
...
abstract class _UserAddress implements UserAddress {
  factory _UserAddress(
      ...
      required bool is_remote}) = _$UserAddressImpl;
