...
class _$UserScheduleImpl implements _UserSchedule {
  ...
  @override
  String toString() {
    return 'UserSchedule(id: $id, required: $required, user_id: $user_id, scheduled_start_work: $scheduled_start_work, scheduled_end_work: $scheduled_end_work)';
  }
...
abstract class _UserSchedule implements UserSchedule {
  factory _UserSchedule(
      ...
      required DateTime scheduled_end_work}) = _$UserScheduleImpl;
