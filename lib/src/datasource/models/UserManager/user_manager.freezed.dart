...
abstract class $UserManagerCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int user_id, int manager_id});
}
...
class _$UserManagementImpl implements _UserManagement {
  _$UserManagementImpl(
      {required this.id, required this.user_id, required this.manager_id});
  ...
  @override
  String toString() {
    return 'UserManager(id: $id, user_id: $user_id, manager_id: $manager_id)';
  }
...
abstract class _UserManagement implements UserManager {
  factory _UserManagement(
      ...
      required int manager_id}) = _$UserManagementImpl;
